...
class HaritaScreen extends StatefulWidget {
  final HaritaController controller;

  const HaritaScreen({Key? key, required this.controller}) : super(key: key);
...
class _HaritaScreenState extends State<HaritaScreen> {
  static const _initialCameraPosition = CameraPosition(
    target: LatLng(37.773972, -122.431297), // Default position (San Francisco)
    zoom: 11.5,
  );
  ...
  void _addMarker(LatLng pos) async {
    if (_origin == null || (_origin != null && _destination != null)) {
      ...
      // Fetch directions
      final directions = await widget.controller.getDirections(
